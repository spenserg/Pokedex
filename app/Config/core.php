 ...
 */
	...
	App::uses('AppError', 'Lib');  // Custom Error Handler
 ...
 */
	Configure::write('Session', array(
		...
		'checkAgent' => false, // ignore changes in user-agent
		'autoRegenerate' => false  // buggy
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'DyhG93b0qyJfIxfs2iuVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859409657453542496849683645');
